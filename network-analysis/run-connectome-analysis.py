...
user_parameters['mainFolder']= f'{PC_disc}:\Connectomics-Data'
...
user_parameters['dataPath']= f'{PC_disc}:\Connectomics-Data\datasets\NeuPrint\fib25'
user_parameters['file']='C_column_fib25.csv'#dataset file in cvs format. leave empty if calling data from NeuPrint
user_parameters['column']='-E' # before: 'F-column', 'home-column'; use better just: '-F', 'home'
